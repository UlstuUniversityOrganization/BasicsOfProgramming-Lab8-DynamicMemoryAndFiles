#include "framework.h"
#include "BasicsOfProgramming-Lab8-DynamicMemoryAndFiles.h"
#include <stdio.h>
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_BASICSOFPROGRAMMINGLAB8DYNAMICMEMORYANDFILES, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_BASICSOFPROGRAMMINGLAB8DYNAMICMEMORYANDFILES));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_BASICSOFPROGRAMMINGLAB8DYNAMICMEMORYANDFILES));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_BASICSOFPROGRAMMINGLAB8DYNAMICMEMORYANDFILES);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		WriteArrayToFile(num2, elementsCount2, "OutputData.txt");
		break;
	}
	case WM_PAINT:
	{
